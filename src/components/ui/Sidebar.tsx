...
export default function Sidebar() {
  return (
    <div className="hidden md:block w-[220px]">
      <div className="w-[220px] bg-[#0000001a] border-r border-r-[#2e2e38] p-4 flex flex-col gap-8 h-full  fixed top-0 left-0 bottom-0 z-50">
        <a href="/search">
          <svg
            width="45"
        ...
        <MenuList />
        <div className="flex flex-col gap-2 justify-end items-start flex-grow -mt-[35px] text-[12px]  text-[#777]">
          <span className="">
            Podbay v2.9.6 by <a href="https://fancysoups.com">Fancy Soups.</a>
          </span>
